...
public class WorldClass extends World
{
    ...
    private void powerups(){
         int powerups = lastPipe + Greenfoot.getRandomNumber(400) - 100;
        if(powerups < 100) powerups = 100 + Greenfoot.getRandomNumber(150);
        if(powerups > 400) powerups = 400 - Greenfoot.getRandomNumber(150); 

        addObject(new TopPipe(powerups), 0, 0);
